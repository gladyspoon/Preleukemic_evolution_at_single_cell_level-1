...
Codes used for training the ML classifier (Figure 3) and evaluating model performance (Supplementary Figure 6): 
  Github - Training classifier model (k=4, n=300).ipynb
  Github - Model performance after training.ipynb
Codes used for inferring evolutionary parameters from real data (Figure 4, S8):
